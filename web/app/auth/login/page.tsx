        ...
        <div className="w-full max-w-sm mt-16 md:mt-0 animate-in fade-in slide-in-from-bottom-4 duration-500">
          <div className="mb-8">
            ...
            <p className="text-[15px] text-stone-500">
              No account?{' '}
              <Link href="/auth/register" className="text-[#1C1E26] font-medium hover:text-stone-700 transition-colors">
                Create one
              </Link>
            </p>
          </div>
          ...
          <div className="space-y-3">
            <button
              ...
              type="button"
              className="w-full h-12 bg-white text-[#1C1E26] rounded-full border border-stone-300 flex items-center justify-center gap-3 text-sm font-medium hover:bg-stone-50 active:scale-[0.98] transition-all"
            >
            ...
            <button
              ...
              type="button"
              className="w-full h-12 bg-transparent border border-stone-300 text-[#1C1E26] rounded-full flex items-center justify-center gap-3 text-sm font-medium hover:bg-white active:scale-[0.98] transition-all"
            >
              <Chrome className="w-5 h-5 text-[#4B83C4]" />
          ...
          <div className="flex items-center gap-4 my-8">
            ...
            <span className="text-[13px] text-stone-400 font-medium tracking-wide">Or</span>
            <div className="flex-1 h-px bg-stone-200/80" />
          </div>
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            ...
            <div className="flex justify-end pt-1 pb-2">
              <Link href="/auth/reset-password" className="text-[13px] text-stone-500 hover:text-[#1C1E26] transition-colors">
                Forgot password?
              </Link>
            </div>
          ...
          <div className="mt-8 text-center text-[13px] text-stone-500 leading-relaxed">
            By logging in, you agree with Inline&apos;s<br />
